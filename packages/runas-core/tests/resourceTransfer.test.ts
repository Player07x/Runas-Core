...
const item: CharacterInventoryItem = { id: "item-1", usage: "equipped", name: "Espada", type: "weapon", affinity: 1, bondPoints: 0, baseWeight: 2, size: 80, mt: 0, quantity: 1, applyScaleWeight: false, damage: "1d8", rdf: 0, rdm: 0, equippedAsArmor: false, prCurrent: null, prMaximum: null, enchantmentSpellId: "spell-1", bondId: "bond-1", bondAbilityId: "ability-1", skillId: "", description: "" }
