...
export function CampaignStory({ stories, allStories, pages, eras, onCreate, onLink, onUnlink, onOpenStory, onBack = () => { if (typeof window !== "undefined") window.history.back() } }: { stories: KnowledgePage[]; allStories: KnowledgePage[]; pages: KnowledgePage[]; eras: UniverseEra[]; onCreate: () => void; onLink: (id: string) => void; onUnlink: (id: string) => void; onOpenStory: (story: KnowledgePage) => void; onBack?: () => void }) {
